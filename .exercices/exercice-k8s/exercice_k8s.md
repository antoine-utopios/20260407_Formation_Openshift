# Exercice Kubernetes #1 - Déploiement d'une application full-stack

Vous êtes chargé de déployer l'intégralité d'une application dans un cluster Openshift local. Cette application possède plusieurs couches métier. Ces couches tourneront dans un cluster et séparés du reste de ce dernier via l'utilisation d'un namespace dédié.
...
* Instancier un nouveau projet avec `oc new-project`
